...
map<string, string>* initMap() {
    map<string, string>* m = new map<string, string>[12]; // 注意这里的大小应该与状态数一致

    m[0]["("] = "s4"; m[0]["id"] = "s5"; m[0]["E"] = "1"; m[0]["T"] = "2"; m[0]["F"] = "3";

    m[1]["+"] = "s6"; m[1]["$"] = "acc";

    m[2]["+"] = "r2"; m[2]["*"] = "s7"; m[2][")"] = "r2"; m[2]["$"] = "r2";

    m[3]["+"] = "r4"; m[3]["*"] = "r4"; m[3][")"] = "r4"; m[3]["$"] = "r4";

    m[4]["("] = "s4"; m[4]["id"] = "s5"; m[4]["E"] = "8"; m[4]["T"] = "2"; m[4]["F"] = "3";

    m[5]["+"] = "r6"; m[5]["*"] = "r6"; m[5][")"] = "r6"; m[5]["$"] = "r6";

    m[6]["("] = "s4"; m[6]["id"] = "s5"; m[6]["T"] = "9"; m[6]["F"] = "3";

    m[7]["("] = "s4"; m[7]["id"] = "s5"; m[7]["F"] = "10";

    m[8]["+"] = "s6"; m[8][")"] = "s11";

    m[9]["+"] = "r1"; m[9]["*"] = "s7"; m[9][")"] = "r1"; m[9]["$"] = "r1";

    m[10]["+"] = "r3"; m[10]["*"] = "r3"; m[10][")"] = "r3"; m[10]["$"] = "r3";
